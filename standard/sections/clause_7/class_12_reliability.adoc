...
[NOTE]
====
Availability is calculated as: (Total time - Downtime) / Total time × 100%, measured monthly. Uptime excludes scheduled maintenance windows but includes all unplanned outages.
====
