...
System Specifications_ (WMO-No. 1131, 2025 Edition).

WMO-No. 1131 provides a comprehensive framework for Climate Data Management Systems (CDMS), describing key
components, governance principles, and operational practices using the classifications "Required", "Recommended",
and "Optional". The high-level nature of those classifications makes it difficult in practice to assess objectively
whether a given system meets the standard. This document translates the WMO-No. 1131 framework into a set of
concrete requirements against which a CDMS can be assessed.

This document is primarily intended as: a tool to help WMO Members assess whether an existing or proposed CDMS
meets the minimum capabilities described in WMO-No. 1131; and a reference to help developers understand the
minimum capabilities expected of a conformant system. It is not a detailed technical specification or
implementation guide — specific architectural and technology choices remain the responsibility of the
