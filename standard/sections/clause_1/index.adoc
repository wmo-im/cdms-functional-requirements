...
approach. This specification does not place new mandatory obligations on WMO Members, and is not intended
as a list of requirements that Members SHALL or SHOULD follow.
